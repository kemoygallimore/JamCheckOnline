    ...
    <div class="Form-center">
        <div style="width:480px">
            <asp:Panel ID="Panel1" runat="server">
                ...
                <h2 style="text-align:center;font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; padding-bottom: 1em;">Create Account</h2>
                <table style="padding: 20px 40px; border: 2px solid #00FF00;border-radius:10px">
                    <tbody>
                        <tr>
                            <td class="Half right">
                                <asp:Label ID="Label1" runat="server" Text="First Name" Font-Size="14pt"></asp:Label>
                            </td>
                            <td class="Half">
                                <asp:TextBox ID="fnametxtbx" runat="server" Font-Size="13pt" Width="170px" Font-Names="Arial Narrow"></asp:TextBox>
                        ...
                        <tr>
                            <td class="Half right">
                                <asp:Label ID="Label14" runat="server" Text="Last Name" Font-Size="14pt"></asp:Label>
                            </td>
                            <td class="Half">
                                <asp:TextBox ID="lnametxtbx" runat="server" Font-Size="13pt" Width="170px" Font-Names="Arial Narrow"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="Half right ">
                                <asp:Label ID="Label13" runat="server" Text="TRN #" Font-Size="14pt"></asp:Label>
                            </td>
                            <td class="Half">
                                <asp:TextBox ID="TRNtxtbx" runat="server" Font-Size="13pt" Width="170px" TextMode="Number" Font-Names="Arial Narrow"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="Half right " >
                                <asp:Label ID="Label12" runat="server" Text="D.O.B" Font-Size="14pt"></asp:Label>
                            </td>
                            <td class="Half">
                                <asp:TextBox ID="DOBtxtbx" placeholder="DD/MM/YYYY" runat="server" Width="170px" TextMode="Date" Font-Names="Arial Narrow" Font-Size="13pt"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="Half right ">
                                <asp:Label ID="Label11" runat="server" Text="Email" Font-Size="14pt"></asp:Label>
                            </td>
                            <td class="Half">
                                <asp:TextBox ID="Eamiltxtbx" runat="server" Font-Size="13pt" Width="170px" TextMode="Email" Font-Names="Arial Narrow"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="Half right ">
                                <asp:Label ID="Label10" runat="server" Text="Password" Font-Size="14pt"></asp:Label>
                            </td>
                            <td class="Half">
                                <asp:TextBox ID="Passwordtxtbx" runat="server" Font-Size="13pt" Width="170px" Font-Names="Arial Narrow"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="Half right ">
                                <asp:Label ID="Label9" runat="server" Text="Confirm Password" Font-Size="14pt"></asp:Label>
                            </td>
                            <td class="Half">
                                <asp:TextBox ID="PasswordConftxtbx" runat="server" Font-Size="13pt" Width="170px" Font-Names="Arial Narrow"></asp:TextBox>
                        ...
                        <tr >
                            ...
                            <td class="Half button-area" style="text-align:center">
                                <button href="Login.aspx" class="buttonlink"> <strong>Login</strong> </button>
                            </td>
                                
                            <td style="text-align:center" class="half button-area">
                                <asp:Button ID="Submitbtn" runat="server" Text="Submit" OnClick="Button1_Click"  Width="100" BorderStyle="Solid" BorderColor="Black" Font-Bold="True" Cssclass="buttonlink" />
                            </td>
                        </tr>
                    </tbody>
                </table>
